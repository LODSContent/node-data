  ...
  function testWriteData () {
    ...
    function clearProductLine () {
      pool.getConnection((_err, connection) => {
        connection.query('DELETE FROM productlines WHERE productLine = ?', [testProductLine.productlineName], (_error, _data, _fields) => {
          connection.release()
    ...
    function testInsert () {
      testPool.getConnection((_err, connection) => {
        connection.query('SELECT * from productlines WHERE productLine = ?', [testProductLine.productlineName], (error, data, _fields) => {
          if (error) {
            console.log(error)
          }
    ...
    function testUpdate () {
      testPool.getConnection((_err, connection) => {
        connection.query('SELECT * from productlines WHERE productLine = ?', [testProductLine.productlineName], (_error, data, _fields) => {
